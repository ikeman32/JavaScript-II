...
let firstNamesAllCaps = runners.map(run => {
...
console.log("Shirt size L", runnersLargeSizeShirt);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations and save the total into a ticketPriceTotal variable.
let ticketPriceTotal = runners.reduce((accumulator, value) => {
...
// Problem 1
let alphabeticalLastNames = runners.filter(name => name.last_name);
...
alphabeticalLastNames = alphabeticalLastNames.sort(compareNames)
console.log('sorted Object by lastNames', alphabeticalLastNames);
